...
class PackageManager {
     ...
     */
    static ensureIgniteUISource() {
        return __awaiter(this, arguments, void 0, function* (installNow = false, templateManager, verbose = false) {
    ...
    static installPackages() {
        return __awaiter(this, arguments, void 0, function* (verbose = false) {
            const config = util_1.ProjectConfig.localConfig();
    ...
    static removePackage(packageName, verbose = false) {
        ...
        try {
            ...
            util_1.Util.spawnSync(managerCommand, args, { stdio: "pipe", encoding: "utf8" });
        }
        catch (error) {
    ...
    static queuePackage(packageName_1) {
        return __awaiter(this, arguments, void 0, function* (packageName, verbose = false) {
    ...
    static flushQueue(logSuccess_1) {
        return __awaiter(this, arguments, void 0, function* (logSuccess, verbose = true) {
    ...
    static ensureRegistryUser(config, message) {
        ...
        try {
            // tslint:disable-next-line:object-literal-sort-keys
            util_1.Util.spawnSync('npm', ['whoami', `--registry=${fullPackageRegistry}`], { stdio: 'pipe', encoding: 'utf8' });
        }
        catch (error) {
            ...
            const login = util_1.Util.spawnSync(cmd, ["adduser", `--registry=${fullPackageRegistry}`, `--scope=@infragistics`, `--always-auth`], { stdio: "inherit" });
            if ((login === null || login === void 0 ? void 0 : login.status) === 0) {
                //make sure scope is configured:
                try {
                    util_1.Util.spawnSync('npm', ['config', 'set', `@infragistics:registry`, fullPackageRegistry]);
                    return true;
                }
                catch (error) {
                    return false;
