...
export declare abstract class IgxGridBaseDirective implements GridType, OnInit, DoCheck, OnDestroy, AfterContentInit, AfterViewInit {
    ...
    */
    ...
    protected _firstAutoResize: boolean;
    ...
    private _pinning;
    private _shouldRecalcRowHeight;
    private _hostWidth;
    ...
    /** @hidden @internal */
    summaryService: IgxGridSummaryService, localeId: string, platform: PlatformUtil, _diTransactions?: TransactionService<Transaction, State>);
    /**
     * @hidden
     * @internal
     */
     ...
     * @hidden
     */
    resolveDataTypes(rec: any): "string" | "number" | "boolean" | "image" | "date";
    /**
     * @hidden
     */
